export const NativeSaleAbi: any = [
  {
    inputs: [
      { internalType: 'address payable', name: 'node_', type: 'address' },
      { internalType: 'address', name: 'priceFeed_', type: 'address' },
      { internalType: 'bytes32', name: 'priceFeedID_', type: 'bytes32' },
      { internalType: 'uint256', name: 'priceThreshold_', type: 'uint256' },
    ],
  ...
  { inputs: [], name: 'ZeroAddressError', type: 'error' },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'enum INode.Variant', name: 'variant', type: 'uint8' },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'priceFeedTimeThreshold', type: 'uint256' },
    ],
  ...
  {
    inputs: [{ internalType: 'address', name: 'priceFeed_', type: 'address' }],
  ...
  {
    inputs: [{ internalType: 'bytes32', name: 'pythPriceFeedID_', type: 'bytes32' }],
    name: 'setPriceFeedID',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'priceThreshold_', type: 'uint256' }],
